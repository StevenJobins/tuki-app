...
const recipes = [
  ...
  { id: 'apple-muffins', title: { de: 'Apfel-Zimt-Muffins', en: 'Apple Muffins', fr: 'Muffins Pomme' }, desc: { de: 'Saftig, perfekt für Herbst', en: 'Juicy, perfect for fall', fr: 'Juteux, parfait automne' }, image: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=600&h=400&fit=crop', time: '35 min', age: '2+', tag: { de: 'Saisonal', en: 'Seasonal', fr: 'Saisonnier' } },
  { id: 'banana-bread', title: { de: 'Bananenbrot', en: 'Banana Bread', fr: 'Pain Banane' }, desc: { de: 'Saftig – auch nächster Tag lecker', en: 'Moist – good next day', fr: 'Moelleux – bon lendemain' }, image: 'https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=600&h=400&fit=crop', time: '60 min', age: '2+', tag: { de: 'Vorrat', en: 'Batch', fr: 'Batch' } }
];
