    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pb-8">
      ...
      <div className="mx-4 mt-4 bg-tuki-mint-bg border border-tuki-mint rounded-2xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-xs text-tuki-rot-dark">{t.recipeDetail.tukiTip}</h3>
      ...
      <div className="px-4 mt-6">
        <h2 className="font-semibold text-base text-gray-800 mb-3">{t.recipeDetail.ingredients}</h2>
