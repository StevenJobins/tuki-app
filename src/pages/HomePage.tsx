  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="pb-24">
        ...
        <div className="relative rounded-3xl overflow-hidden gradient-mint p-5">
          <div className="relative z-10">
            <p className="text-tuki-rot-dark text-sm font-medium">
              {getGreeting()} {activeChild ? activeChild.avatarEmoji : '👋'}
            </p>
      ...
      <motion.div variants={item}>
        <SectionHeader
          title={activeChild ? `Rezepte für ${activeChild.name}` : 'Beliebte Rezepte'}
          emoji="🍳"
          linkTo="/rezepte"
        />
      ...
      <motion.div variants={item} className="mt-6">
        <SectionHeader
          title={activeChild ? `Aktivitäten für ${activeChild.name}` : 'Aktivitäten für heute'}
          emoji="🎯"
          linkTo="/aktivitaeten"
        />
