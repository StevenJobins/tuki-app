...
const seedPosts: CommunityPost[] = [
  {
    ...
    likes: 24,
    comments: [
      { id: 'c1a', author: 'Marco B.', avatar: '\u{1F468}', timeAgo: 'vor 1 Std.', text: 'Super! Welches Rezept war das genau? Wir suchen noch einfache Sachen für unseren Kleinen.' },
      { id: 'c1b', author: 'Sarah K.', avatar: '\u{1F469}', timeAgo: 'vor 1 Std.', text: 'Das sieht so lecker aus! Die Pancakes aus der App sind bei uns auch der Hit.' },
      { id: 'c1c', author: 'Julia H.', avatar: '\u{1F469}‍\u{1F9B1}', timeAgo: 'vor 45 Min.', text: 'Toll! Ab welchem Alter klappt das gut?' },
    ],
    tag: 'Rezept',
  },
  {
    ...
    likes: 41,
    comments: [
      { id: 'c2a', author: 'Thomas M.', avatar: '\u{1F468}‍\u{1F9B2}', timeAgo: 'vor 4 Std.', text: 'Genau das gleiche bei uns! Der Tuki am Waschbecken ist ein Game-Changer.' },
      { id: 'c2b', author: 'Alena Z.', avatar: '\u{1F469}‍\u{1F9B0}', timeAgo: 'vor 3 Std.', text: 'Welche Höhenstufe nutzt ihr dafür?' },
      { id: 'c2c', author: 'Marco B.', avatar: '\u{1F468}', timeAgo: 'vor 3 Std.', text: '@Alena Stufe 2 bei uns, sie ist 87cm gross.' },
      { id: 'c2d', author: 'Sarah K.', avatar: '\u{1F469}', timeAgo: 'vor 2 Std.', text: 'Das probieren wir heute Abend direkt aus!' },
    ],
    tag: 'Tipp',
  },
  {
    ...
    likes: 35,
    comments: [
      { id: 'c3a', author: 'Julia H.', avatar: '\u{1F469}‍\u{1F9B1}', timeAgo: 'vor 20 Std.', text: 'Die Energy Balls sind bei uns auch der Favorit! Wir machen sie jede Woche.' },
      { id: 'c3b', author: 'Thomas M.', avatar: '\u{1F468}‍\u{1F9B2}', timeAgo: 'vor 18 Std.', text: '20 Minuten Ruhe? Das ist beeindruckend!' },
    ],
    tag: 'Rezept',
  },
  {
    ...
    likes: 12,
    comments: [
      { id: 'c4a', author: 'Marco B.', avatar: '\u{1F468}', timeAgo: 'vor 2 Tagen', text: 'Bei 18 Monaten haben wir Stufe 3 genutzt. Kommt aber auf die Grösse an!' },
      { id: 'c4b', author: 'Alena Z.', avatar: '\u{1F469}‍\u{1F9B0}', timeAgo: 'vor 2 Tagen', text: 'Wir auch Stufe 3. Am besten einmal ausprobieren, ob sie bequem an die Kante kommt.' },
      { id: 'c4c', author: 'Thomas M.', avatar: '\u{1F468}‍\u{1F9B2}', timeAgo: 'vor 1 Tag', text: 'Schau mal in der App unter dem Tuki-Guide, da gibt es eine Tabelle mit Empfehlungen nach Grösse.' },
      { id: 'c4d', author: 'Sarah K.', avatar: '\u{1F469}', timeAgo: 'vor 1 Tag', text: 'Stufe 3 ist ein guter Start. Unsere war mit 18 Monaten auch auf Stufe 3.' },
      { id: 'c4e', author: 'Julia H.', avatar: '\u{1F469}‍\u{1F9B1}', timeAgo: 'vor 1 Tag', text: 'Danke euch allen! Wir probieren Stufe 3 aus.' },
    ],
    tag: 'Frage',
  },
  {
    ...
    likes: 52,
    comments: [
      { id: 'c5a', author: 'Alena Z.', avatar: '\u{1F469}‍\u{1F9B0}', timeAgo: 'vor 3 Tagen', text: 'Wie schön! Hast du ein Foto?' },
      { id: 'c5b', author: 'Sarah K.', avatar: '\u{1F469}', timeAgo: 'vor 2 Tagen', text: 'Das müssen wir auch unbedingt ausprobieren! Perfekt für den Herbst.' },
      { id: 'c5c', author: 'Marco B.', avatar: '\u{1F468}', timeAgo: 'vor 2 Tagen', text: 'Tolle Idee! Blätter-Tiere klingt super kreativ.' },
    ],
    tag: 'Aktivität',
  },
]
