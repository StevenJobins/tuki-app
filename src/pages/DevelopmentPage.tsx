      ...
      {activeChild && (
        <div className="mx-4 mt-2 mb-3 bg-purple-50 rounded-2xl p-3 border border-purple-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-800">Entwicklung von {activeChild.name}</p>
              <p className="text-xs text-gray-500">Meilensteine individuell tracken</p>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="px-4 mb-4">
        <div className="bg-white rounded-2xl p-4 border border-gray-100">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-semibold text-gray-700">{activeChild ? activeChild.name + ': ' + group.label : group.label}</span>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <h3 className={'font-semibold text-sm ' + (done ? 'text-green-700' : 'text-gray-800')}>{ms.title}</h3>
                      <span className="text-[10px] text-gray-400 bg-gray-50 px-2 py-0.5 rounded-full">
                        {(t.development.milestoneCategories as Record<string, string>)[ms.category] || ms.category}
                      </span>
                    </div>
