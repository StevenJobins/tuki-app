...
const activities = [
  {
    ...
    age: '2-4',
    skills: ['Feinmotorik', 'Konzentration']
  },
  {
    id: 'eier-aufschlagen',
    title: { de: 'Eier aufschlagen', en: 'Cracking Eggs', fr: 'Casser Œufs' },
    desc: { de: 'Zwei-Hände-Koordination', en: 'Two-hand coordination', fr: 'Coordination deux mains' },
    image: 'https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?w=600&h=400&fit=crop',
    age: '2-5',
    skills: ['Koordination', 'Geduld']
  },
  {
    id: 'gemuese-waschen',
    title: { de: 'Gemüse waschen', en: 'Washing Vegetables', fr: 'Laver Légumes' },
    desc: { de: 'Sensorisches Wassererlebnis', en: 'Sensory water play', fr: 'Expérience eau' },
    image: 'https://images.unsplash.com/photo-1466637574441-749b8f19452f?w=600&h=400&fit=crop',
    age: '1-4',
    skills: ['Sinne', 'Lebenspraxis']
  },
  {
    id: 'wasser-giessen',
    title: { de: 'Wasser gießen', en: 'Pouring Water', fr: 'Verser Eau' },
    desc: { de: 'Konzentration und Kontrolle', en: 'Focus and control', fr: 'Concentration' },
    image: 'https://images.unsplash.com/photo-1516726817505-f5ed825624d8?w=600&h=400&fit=crop',
    age: '1-3',
    skills: ['Gleichgewicht', 'Handkraft']
  },
  {
    id: 'brot-schneiden',
    title: { de: 'Brot schneiden', en: 'Cutting Bread', fr: 'Couper Pain' },
    desc: { de: 'Frühstück mitgestalten', en: 'Help with breakfast', fr: 'Aider petit-déj' },
    image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&h=400&fit=crop',
    age: '2-5',
    skills: ['Selbstständigkeit']
  },
  {
    id: 'tisch-decken',
    title: { de: 'Tisch decken', en: 'Setting Table', fr: 'Dresser Table' },
    desc: { de: 'Familienritual teilen', en: 'Family ritual', fr: 'Rituel famille' },
    image: 'https://images.unsplash.com/photo-1466978913421-dad2ebd01d71?w=600&h=400&fit=crop',
    age: '2-6',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {activities.map(activity => (
              <Link 
                ...
                className="group bg-tuki-sand rounded-2xl overflow-hidden hover:shadow-xl transition-all flex flex-col sm:flex-row"
              >
