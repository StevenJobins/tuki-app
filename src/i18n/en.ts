...
const en: Translations = {
  ...
  seasonalTip: {
    ...
    winter: { emoji: '❄️', title: 'Winter tip', text: 'Fresh air does good even in the cold: wrap up warm and do not forget a hat. Indoors, active games help against cabin fever.' },
  },
  ...
  development: {
    ...
    ageGroups: ['12-18 mo.', '18-24 mo.', '2-3 years', '3-5 years', '5-8 years'],
    milestoneCategories: {
      motorik: 'Motor Skills',
    ...
    developmentOf: (name: string) => `${name}'s development`,
    trackIndividually: 'Track milestones individually',
    milestones: {
      ...
      m17: { title: 'Riding a bike (without training wheels)', description: 'Rides a bike safely without training wheels.' },
      m18: { title: 'Reading the clock (full hours)', description: 'Can read the clock and name full hours.' },
      m19: { title: 'Expressing own opinion', description: 'Can clearly express own wishes and opinions.' },
      m20: { title: 'Reading short texts', description: 'Reads simple words and short sentences independently.' },
    },
  },
