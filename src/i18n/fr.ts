...
const fr: Translations = {
  ...
  stepMode: {
    ...
    stepDone: 'Fait',
    stepsCompleted: 'Ã©tapes terminÃ©es',
    finish: (stars: number) => `Bravo ! +${stars} Ã©toiles gagnÃ©es`,
    alreadyCompleted: 'DÃ©jÃ  terminÃ©',
  },
  ...
  notifications: {
    ...
    footer: 'Voici vos derniÃ¨res mises Ã  jour',
  ...
  community: {
    ...
    commentPlaceholder: 'Ãcrire un commentaire...',
    commentJustNow: 'Ã  l\'instant',
  },
  ...
  accountSettings: {
    ...
    emailSuccess: 'E-mail de confirmation envoyÃ© ! VÃ©rifie ta boÃ®te de rÃ©ception.',
    passwordSection: 'Mot de passe',
    currentPassword: 'Mot de passe actuel',
    newPassword: 'Nouveau mot de passe',
    newPasswordPlaceholder: 'Min. 6 caractÃ¨res',
    confirmPassword: 'Confirmer le mot de passe',
    confirmPasswordPlaceholder: 'Entrer Ã  nouveau',
    changePassword: 'Changer le mot de passe',
    passwordSuccess: 'Mot de passe changÃ© avec succÃ¨s !',
    passwordTooShort: 'Le mot de passe doit contenir au moins 6 caractÃ¨res.',
    passwordMismatch: 'Les mots de passe ne correspondent pas.',
    logout: 'Se dÃ©connecter',
    dangerZone: 'Zone de danger',
    deleteWarning: 'La suppression de ton compte effacera dÃ©finitivement toutes tes donnÃ©es, favoris et progrÃ¨s.',
