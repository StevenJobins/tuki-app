...
const fr: Translations = {
  ...
  accountSettings: {
    ...
    deleteWarning: 'La suppression de ton compte supprimera définitivement toutes tes données, favoris et progrès.',
  ...
  starShop: {
    ...
    noStarsDesc: 'Termine des recettes et activités pour gagner des étoiles !',
    rewards: {
      'badge-chef': { name: 'Badge Chef', desc: 'Montre ton talent culinaire' },
      'badge-star': { name: 'Badge Superstar', desc: 'Tu es une superstar' },
      'badge-rocket': { name: 'Badge Fusée', desc: 'Vers les étoiles' },
      ...
      'activity-painting': { name: 'Aventure Peinture', desc: 'Être créatif' },
