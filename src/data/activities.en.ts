...
export const activitiesEn: Record<string, {
  ...
  "seifenblasen-fangen": {
    ...
    subtitle: "Jump, grab, marvel",
    materials: ["Bubble set", "A bit of space (indoors or outdoors)"],
    steps: [
      { text: "Slowly blow big bubbles." },
      { text: "Your child tries to catch them with their hands.", tip: "Blow high and low – it challenges movement!" },
      { text: "Count together how many they catch." },
    ],
    learningGoals: ["Gross motor skills", "Hand-eye coordination", "Focus"],
    tukiTip: "Indoors, over a wipeable surface – in the Tuki your child stands safely and reaches up.",
  },
  "becher-stapeln": {
    title: "Stack & topple cups",
    subtitle: "Build, knock down, laugh",
    materials: ["5–6 sturdy or cardboard cups"],
    steps: [
      { text: "Build a tower of cups together." },
      { text: "Your child knocks it over – pure joy!", tip: "Toppling matters as much as building." },
      { text: "Rebuild and start again." },
    ],
    learningGoals: ["Fine motor skills", "Cause & effect", "Patience"],
    tukiTip: "At table height in the Tuki, stacking is even more fun.",
  },
  "barfuss-fuehlpfad": {
    title: "Barefoot sensory path",
    subtitle: "Feel with your feet",
    materials: ["Different materials: towel, sponge, leaves, stones, grass"],
    steps: [
      { text: "Lay the materials out as a path." },
      { text: "Your child walks over it barefoot.", tip: "Hold their hand at first – it gives confidence." },
      { text: "Talk about it: soft, hard, cold, ticklish?" },
    ],
    learningGoals: ["Sensory perception", "Balance", "Words for feelings"],
    tukiTip: "Indoors the path can be set up any time – ideal for rainy days.",
  },
  "reis-schuettstation": {
    title: "Rice pouring station",
    subtitle: "Pour, scoop, feel",
    materials: ["Large bowl of rice (or lentils)", "Cups, spoons, small containers"],
    steps: [
      { text: "Fill a large bowl with rice." },
      { text: "Your child scoops and pours between containers.", tip: "A blanket underneath catches most of it." },
      { text: "Hide small objects to find." },
    ],
    learningGoals: ["Fine motor skills", "Sensory experience", "Experiencing quantities"],
    tukiTip: "At the counter in the Tuki the rice stays nicely in the bowl.",
  },
  "farben-sortieren": {
    title: "Sort by colour",
    subtitle: "Order & name colours",
    materials: ["Colourful objects (blocks, pompoms, lids)", "Bowls in matching colours"],
    steps: [
      { text: "Mix colourful objects in a bowl." },
      { text: "Your child sorts them by colour into the bowls.", tip: "Name the colours out loud together." },
      { text: "At the end: which colour has the most?" },
    ],
    learningGoals: ["Recognising colours", "Sorting & categorising", "First quantity concepts"],
    tukiTip: "At eye level in the Tuki your child sorts independently – building autonomy.",
  },
  "muster-legen": {
    title: "Make & continue patterns",
    subtitle: "Spot and extend sequences",
    materials: ["Colourful blocks, buttons or stones"],
    steps: [
      { text: "Lay a simple row: red, blue, red, blue …" },
      { text: "Your child continues the pattern.", tip: "Start simple, make it trickier over time." },
      { text: "Let your child invent their own pattern." },
    ],
    learningGoals: ["Logical thinking", "Pattern recognition", "Early maths skill"],
    tukiTip: "At the table in the Tuki your child sees everything and focuses well.",
  },
  "tiergeraeusche-raten": {
    title: "Guess the animal sound",
    subtitle: "Listen, imitate, name",
    materials: ["Animal pictures or figurines (optional)"],
    steps: [
      { text: "Make an animal sound: “Moo!”" },
      { text: "Your child guesses which animal it is.", tip: "Joining in loudly is the most fun!" },
      { text: "Swap roles – your child makes the sound." },
    ],
    learningGoals: ["Language development", "Listening", "Naming animals"],
    tukiTip: "Perfect on the go or while cooking in the Tuki – no materials needed.",
  },
  "reim-spiel": {
    title: "Rhyming game",
    subtitle: "Find words that rhyme",
    materials: ["Just your voices"],
    steps: [
      { text: "Say a word, e.g. “cat”." },
      { text: "Your child finds a rhyme: “hat”, “mat”.", tip: "Silly words count too – as long as it rhymes!" },
      { text: "Make a little rhyme together." },
    ],
    learningGoals: ["Feel for language", "Phonological awareness", "Vocabulary"],
    tukiTip: "Play while setting the table in the Tuki – language grows in everyday life.",
  },
  "fingerfarben-kunst": {
    title: "Finger-paint artwork",
    subtitle: "Squish, paint, marvel",
    materials: ["Non-toxic finger paints", "Large paper", "Apron & protective surface"],
    steps: [
      { text: "Set out paper and paints." },
      { text: "Your child paints freely with their fingers.", tip: "It's about the experience, not the result." },
      { text: "Hang the artwork up to dry." },
    ],
    learningGoals: ["Creativity", "Fine motor skills", "Sensory experience"],
    tukiTip: "Standing at the counter in the Tuki, your child paints with their whole body.",
  },
  "natur-mandala": {
    title: "Make a nature mandala",
    subtitle: "Collect & arrange beautifully",
    materials: ["Natural materials: leaves, stones, flowers, pine cones"],
    steps: [
      { text: "Collect natural materials together." },
      { text: "Lay a round pattern from the inside out.", tip: "There's no right way – every mandala is unique." },
      { text: "Take a photo as a keepsake." },
    ],
    learningGoals: ["Creativity", "Fine motor skills", "Connection with nature"],
    tukiTip: "Sorting the treasures is done with focus at Tuki height.",
  },
  "eis-schmelz-experiment": {
    title: "Ice-melting experiment",
    subtitle: "Explore what happens to ice",
    materials: ["Ice cubes", "Warm water, salt, spoon", "Small toy figures (freeze in, optional)"],
    steps: [
      { text: "Put ice cubes in a bowl." },
      { text: "Test it: what melts ice faster – a hand, warm water or salt?", tip: "Ask together: why might that be?" },
      { text: "Observe and talk about the result." },
    ],
    learningGoals: ["First science", "Cause & effect", "Vocabulary: melt, cold, liquid"],
    tukiTip: "Explore safely at the counter in the Tuki, right up close.",
  },
  "bohne-einpflanzen": {
    title: "Plant a bean",
    subtitle: "Sow & watch it grow",
    materials: ["Dried beans", "Small pot & soil", "Water, sunny spot"],
    steps: [
      { text: "Fill the pot with soil." },
      { text: "Your child pushes in the bean and waters it.", tip: "A photo a day nicely shows the growth." },
      { text: "Watch daily what happens." },
    ],
    learningGoals: ["Responsibility", "Patience", "Understanding nature & growth"],
    tukiTip: "Planting works safely at Tuki height – and watering becomes a daily ritual.",
  },
  "balancier-linie": {
    title: "Balance line",
    subtitle: "Balance along the line",
    materials: ["Tape or a rope for a line on the floor"],
    steps: [
      { text: "Stick a straight (or curvy) line on the floor." },
      { text: "Your child balances along it with arms out.", tip: "Forwards, then backwards – raises the challenge." },
      { text: "Variation: carry an object while walking." },
    ],
    learningGoals: ["Balance", "Gross motor skills", "Body control"],
    tukiTip: "Great indoors – builds the balance that helps your child stand safely in the Tuki too.",
  },
  "weiches-obst-schneiden": {
    title: "Cut soft fruit",
    subtitle: "First cuts with a kids' knife",
    materials: ["Soft fruit (banana, strawberry, kiwi)", "Child-safe knife", "Cutting board"],
    steps: [
      { text: "Show how to hold the knife safely." },
      { text: "Your child cuts soft fruit into pieces.", tip: "Always stay close and help out." },
      { text: "Enjoy the self-cut snack together." },
    ],
    learningGoals: ["Fine motor skills", "Independence", "Practical life skills"],
    tukiTip: "At working height in the Tuki your child cuts safely – a real hands-on experience.",
  },
  "memory-alltag": {
    title: "Memory with everyday objects",
    subtitle: "Remember & find the pairs",
    materials: ["2 identical everyday objects each (spoons, socks, lids)"],
    steps: [
      { text: "Place 4–6 pairs face down on the table." },
      { text: "Take turns flipping two items and find pairs.", tip: "Start with few pairs and increase slowly." },
      { text: "Whoever finds a pair goes again." },
    ],
...
export const categoryInfoEn: Record<string, { label: string; emoji: string; color: string }> = {
  ...
  sensorik: { label: 'Sensory', emoji: '👐', color: 'bg-purple-100 text-purple-700' },
