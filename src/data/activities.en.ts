...
export const activitiesEn: Record<string, {
  ...
  'wasser-giessen': {
    ...
    tukiTip: 'In the Tuki, your child stands perfectly at the sink or worktop. Put a towel underneath â a little mess is part of the fun!',
  },
  'krÃ¤uter-garten': {
    ...
    steps: [
      { text: 'Fill pots with soil â spoon by spoon.', tip: 'Children love scooping. Put newspaper underneath!' },
      { text: 'Scatter seeds on the soil and press down lightly.' },
      { text: 'Water gently â not too much!' },
    ...
    learningGoals: ['Understanding nature & patience', 'Taking responsibility', 'Observing & documenting', 'Understanding connections (water â growth)'],
  ...
  'knete-selber-machen': {
    ...
    steps: [
      ...
      { text: 'Add oil and water.', tip: 'Your child can measure the water â with a measuring cup!' },
    ...
    tukiTip: 'Kneading at eye level in the Tuki â your child has the perfect working posture. Homemade play dough keeps for 2-3 weeks in the fridge!',
  },
  'haende-waschen-lied': {
    ...
    steps: [
      { text: 'Stand together at the sink â adjust the Tuki to the right height!' },
      { text: 'Wet hands and lather up with soap.' },
      { text: 'Sing together while washing: "Wash your hands, wash your hands, every child must do..."', tip: 'The song lasts about 30 seconds â perfect for thorough washing!' },
  ...
  'zÃ¤hlen-beim-kochen': {
    ...
    steps: [
      ...
      { text: 'Count the spoons: "Two spoons of flour â one... two!"', tip: 'Count in an exaggerated way and show enthusiasm!' },
    ...
    tukiTip: 'Cooking in the Tuki makes maths come naturally. Counting, measuring, comparing â it\'s all part of the kitchen experience.',
  },
  'geschichten-kochen': {
    title: 'Story kitchen',
    ...
    steps: [
      ...
      { text: 'Your child continues: what happens next?', tip: 'There\'s no right or wrong â every story is brilliant!' },
    ...
    tukiTip: 'At eye level in the Tuki, stories are best told â your child feels like an equal storytelling partner!',
  },
}

// English category info
export const categoryInfoEn: Record<string, { label: string; emoji: string; color: string }> = {
  motorik: { label: 'Motor Skills', emoji: 'ð¤¸', color: 'bg-orange-100 text-orange-700' },
  sensorik: { label: 'Sensory', emoji: 'ðï¸', color: 'bg-purple-100 text-purple-700' },
  kreativitÃ¤t: { label: 'Creativity', emoji: 'ð¨', color: 'bg-pink-100 text-pink-700' },
  sprache: { label: 'Language', emoji: 'ð¬', color: 'bg-blue-100 text-blue-700' },
  mathe: { label: 'Numbers & Logic', emoji: 'ð¢', color: 'bg-green-100 text-green-700' },
  natur: { label: 'Nature & Knowledge', emoji: 'ð±', color: 'bg-emerald-100 text-emerald-700' },
}
