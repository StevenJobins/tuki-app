...
export const categoryInfo: Record<string, { emoji: string; color: string }> = {
  'Sensorik': { emoji: '🖐️', color: 'bg-purple-50 text-purple-700' },
  'Natur & Wissen': { emoji: '🌱', color: 'bg-green-50 text-green-700' },
  'Zahlen & Logik': { emoji: '🔢', color: 'bg-blue-50 text-blue-700' },
  'Kreativitaet': { emoji: '🎨', color: 'bg-pink-50 text-pink-700' },
  'Motorik': { emoji: '🏃', color: 'bg-orange-50 text-orange-700' },
  'Sprache': { emoji: '📖', color: 'bg-yellow-50 text-yellow-700' },
  'Musik': { emoji: '🎵', color: 'bg-indigo-50 text-indigo-700' },
  'Alltag': { emoji: '🏠', color: 'bg-teal-50 text-teal-700' }
}
